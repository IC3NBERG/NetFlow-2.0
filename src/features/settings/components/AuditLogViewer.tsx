...
export function AuditLogViewer() {
  ...
  return (
    <div className="max-h-[500px] overflow-y-auto py-2 pr-2">
      <div className="relative">
        <div className="absolute left-[13px] top-0 bottom-0 w-0.5 bg-border/40" />
          ...
          {logs.map((log) => {
            ...
            return (
              <div key={log.id} className="flex gap-4 items-center">
                <div className={cn(
                  "relative z-10 shrink-0 flex h-6.5 w-6.5 items-center justify-center rounded-full border-2 border-surface shadow-md transition-all duration-200",
                ...
                <div className="flex-1 flex flex-col gap-1 rounded-xl bg-surface/50 border border-border/40 hover:border-border/80 px-4 py-3 transition-all duration-200">
